<!-- ryeos:signed:2026-09-07T08:22:44Z:69753a4b606f12cfc44ad1891f4f69098ba70206fd603ec9169b7a27b82ddcbd:EdEJFZezSddJrvhnjEZIdOc+1h69L3aYQboUpWBqz25b7bKGXFUQH325WnwC04wr7GQXsXrFlVlO9wZu84BHCg==:741a8bc609b398aaec0685e5aefb682faf5129a66bd192f888d23bb642c18eea -->
---
...
| `release/produce-development-toolchain-stage0.sh`, `release/development-toolchain-stage0-runtime.sh`, `release/verify-development-toolchain-stage0.sh` | Compiler production and artifact verification beside signed compiler-production Tools, using the same helpers for first-bootstrap and Stage1. The necessary publisher-image acquisition entry seeds upstream Rust/Zig archives, ELF tools and explicitly selected image members. | Exact shell/archive/ELF-tool closure; separate acquisition from offline transformation; actual admitted reproduction, byte/manifest comparison and descendants' closure. No duplicated verifier or discovery of execution-host libraries. |
| `release/test-development-toolchain-stage0.sh`, `release/test-development-toolchain-stage0-runtime.sh` | Tests of current producer/verifier; move with the canonical production owner when that conversion is qualified. The compiler behavior fixture is already separate E2E. | Exact retained archive inputs, corrupt/member/ELF refusal and independent equality. No archive mutation or relabeling of bootstrap provenance. |
...
then reusable offline install/relocation/inventory/archive verification. Both
bootstrap and admitted Stage1 must call the same production implementation.
