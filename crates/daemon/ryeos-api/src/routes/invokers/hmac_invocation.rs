...
impl CompiledRouteInvocation for CompiledHmacVerifier {
    ...
    async fn invoke(
        ...
        let webhook_dedupe = &ctx.webhook_dedupe;
        ...
        if let Some(dedupe_cfg) = &self.dedupe {
            ...
            match webhook_dedupe.mark_seen(
...
mod tests {
    ...
    fn make_invocation_ctx(
        ...
        make_invocation_ctx_with_dedupe(
            state,
            headers,
            body_raw,
    ...
    fn make_invocation_ctx_with_dedupe(
        state: ryeos_app::state::AppState,
        headers: HeaderMap,
        body_raw: &[u8],
        webhook_dedupe: std::sync::Arc<crate::routes::webhook_dedupe::WebhookDedupeStore>,
    ) -> RouteInvocationContext {
        RouteInvocationContext {
            route_id: "r1".into(),
