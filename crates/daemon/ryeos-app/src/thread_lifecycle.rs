...
pub fn admit_verified_root_execution_with_timings(
    ...
    subject_plan_context: &PlanContext,
    project_binding: AdmittedProjectBinding,
    verified_subject: Arc<ryeos_engine::engine::VerifiedArtifactAttestation>,
    node_history_policy: &ResolvedNodeThreadHistoryPolicy,
    thread_profile: String,
    ref_bindings: BTreeMap<String, String>,
    usage_subject: Option<UsageSubject>,
    ...
    fn waiter(phase: &str, terminal: Option<&str>) -> crate::runtime_db::FollowWaiter {
        crate::runtime_db::FollowWaiter {
            ...
            children: vec![crate::runtime_db::FollowWaiterChild {
                ...
                sealed_root_request: SealedRootExecutionRequest::storage_test_fixture(),
